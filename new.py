...
# Join :- https://t.me/+ixbPrD2t40UyODg9 #bgmiddoserpython
...
admin_id = ["1400460665","1914933113","-1002157941270"]
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Function to handle the reply when free users run the /bgmi command
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Dictionary to store the last time each user ran the /bgmi command
bgmi_cooldown = {}

COOLDOWN_TIME =0

# Join :- https://t.me/+ixbPrD2t40UyODg9 # Handler for /bgmi command
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Updated to accept target, time, and port
            ...
            response = "✅ Usage :- /bgmi <target> <port> <time>"  # Join :- https://t.me/+ixbPrD2t40UyODg9 # Updated command syntax
    else:
...
# Join :- https://t.me/+ixbPrD2t40UyODg9 # Add /mylogs command to display logs recorded for bgmi and website commands
